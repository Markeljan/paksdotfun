...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen p-4 sm:p-8 text-center bg-slate-950 text-slate-100 overflow-y-auto">
      <div className="flex flex-col items-center w-full max-w-2xl">
        <header className="mb-6 mt-0 w-full">
